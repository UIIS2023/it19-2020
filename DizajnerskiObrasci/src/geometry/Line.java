...
public class Line extends Shape implements Cloneable{
	...
	public Line clone() {
		...
		clonedLine.setStartPoint(new Point(startPoint.getX(),startPoint.getY()));
		clonedLine.setEndPoint(new Point(endPoint.getX(),endPoint.getY()));
	...
	public String toString() {
		return "Line: "+ startPoint + "-->" + endPoint + getColorText()+" ";
	}
